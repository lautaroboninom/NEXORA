...
export const PERMISSION_CODES = {
  ...
  PAGE_GENERAL_CLIENTE: "page.general_cliente",
  ...
  PAGE_LIBERADOS: "page.liberados",
  PAGE_SERVICE_SHEET_PRINCIPAL: "page.service_sheet_principal",
  ...
  PAGE_BEJERMAN_SYNC: "page.bejerman_sync",
  PAGE_BEJERMAN_PURCHASE_ENTRIES: "page.bejerman_purchase_entries",
  PAGE_RECEPCION: "page.recepcion",
  PAGE_DELIVERY_ORDERS: "page.delivery_orders",
  PAGE_ROUTE_SHEET: "page.route_sheet",
  ...
  ACTION_INGRESO_FORCE_HISTORICAL: "action.ingreso.force_historical",
  ACTION_INGRESO_PRINT_EXIT_ORDER: "action.ingreso.print_exit_order",
  ACTION_INGRESO_EMIT_INGRESS_ORDER: "action.ingreso.emit_ingress_order",
  ACTION_INGRESO_FIX_RIS_PREFLIGHT: "action.ingreso.fix_ris_preflight",
  ACTION_INGRESO_PRINT_BARCODE: "action.ingreso.print_barcode",
  ...
  ACTION_BEJERMAN_SYNC_MANAGE: "action.bejerman_sync.manage",
  ACTION_BEJERMAN_PURCHASE_ENTRIES_MANAGE: "action.bejerman_purchase_entries.manage",
  ACTION_BEJERMAN_PURCHASE_ENTRIES_EMIT: "action.bejerman_purchase_entries.emit",
  ACTION_DELIVERY_ORDER_CREATE: "action.delivery_order.create",
  ACTION_DELIVERY_ORDER_PREPARE: "action.delivery_order.prepare",
  ACTION_DELIVERY_ORDER_DELIVER: "action.delivery_order.deliver",
  ACTION_DELIVERY_ORDER_INVOICE: "action.delivery_order.invoice",
  ACTION_DELIVERY_ORDER_CANCEL: "action.delivery_order.cancel",
  ACTION_DELIVERY_ORDER_UPDATE_REMITO_LOCATION: "action.delivery_order.update_remito_location",
  ACTION_DELIVERY_ORDER_GENERATE_BEJERMAN_REMITO: "action.delivery_order.generate_bejerman_remito",
  ACTION_DELIVERY_ORDER_ASSIGN_ARTICLES: "action.delivery_order.assign_articles",
  ACTION_ROUTE_SHEET_MANAGE: "action.route_sheet.manage",
  ACTION_ROUTE_SHEET_COMPLETE: "action.route_sheet.complete",
  ACTION_ROUTE_SHEET_POSTPONE: "action.route_sheet.postpone",
  ACTION_BILLING_VIEW: "action.billing.view",
  ACTION_BILLING_REGISTER_OS_INVOICE: "action.billing.register_os_invoice",
};
...
const ROLE_DEFAULT_PERMISSIONS = {
  tecnico: new Set([
    ...
    PERMISSION_CODES.ACTION_INGRESO_PRINT_BARCODE,
  ...
  admin: new Set([
    ...
    PERMISSION_CODES.ACTION_INGRESO_FORCE_HISTORICAL,
    ...
    PERMISSION_CODES.ACTION_BEJERMAN_PURCHASE_ENTRIES_MANAGE,
    PERMISSION_CODES.ACTION_BEJERMAN_PURCHASE_ENTRIES_EMIT,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_PREPARE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_DELIVER,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_CANCEL,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_UPDATE_REMITO_LOCATION,
    PERMISSION_CODES.ACTION_ROUTE_SHEET_MANAGE,
    PERMISSION_CODES.ACTION_ROUTE_SHEET_COMPLETE,
  ]),
  ventas: new Set([
    PERMISSION_CODES.PAGE_HOME_SEARCH,
    PERMISSION_CODES.PAGE_GENERAL_CLIENTE,
    ...
    PERMISSION_CODES.ACTION_BEJERMAN_PURCHASE_ENTRIES_MANAGE,
    PERMISSION_CODES.ACTION_BEJERMAN_PURCHASE_ENTRIES_EMIT,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_CREATE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_PREPARE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_DELIVER,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_CANCEL,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_UPDATE_REMITO_LOCATION,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_GENERATE_BEJERMAN_REMITO,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_ASSIGN_ARTICLES,
    PERMISSION_CODES.ACTION_ROUTE_SHEET_MANAGE,
  ]),
  jefe_veedor: new Set([
    PERMISSION_CODES.PAGE_HOME_SEARCH,
    ...
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_PREPARE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_DELIVER,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_INVOICE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_CANCEL,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_UPDATE_REMITO_LOCATION,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_GENERATE_BEJERMAN_REMITO,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_ASSIGN_ARTICLES,
    PERMISSION_CODES.ACTION_BILLING_VIEW,
    PERMISSION_CODES.ACTION_BILLING_REGISTER_OS_INVOICE,
  ]),
  recepcion: new Set([
    PERMISSION_CODES.PAGE_HOME_SEARCH,
    PERMISSION_CODES.PAGE_GENERAL_CLIENTE,
  ...
  logistica: new Set([
    PERMISSION_CODES.PAGE_ROUTE_SHEET,
    PERMISSION_CODES.ACTION_ROUTE_SHEET_COMPLETE,
    PERMISSION_CODES.ACTION_ROUTE_SHEET_POSTPONE,
    PERMISSION_CODES.ACTION_DELIVERY_ORDER_DELIVER,
  ]),
};

ROLE_DEFAULT_PERMISSIONS.supervisor = new Set([
  ...ROLE_DEFAULT_PERMISSIONS.admin,
  ...ROLE_DEFAULT_PERMISSIONS.ventas,
  ...ROLE_DEFAULT_PERMISSIONS.recepcion,
  PERMISSION_CODES.ACTION_ROUTE_SHEET_POSTPONE,
]);
