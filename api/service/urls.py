...
from .views import (
    ...
    MarcarReparadoView, MarcarParaRepararView, QuitarRepararView, MarcarControladoSinDefectoView, MarcarNoSeReparaView, QuitarEstadoFinalReparacionView, EntregarIngresoView, GarantiaReparacionCheckView, GarantiaFabricaCheckView,
    ...
    # detalle de ingreso
    IngresoDetalleView, IngresoBejermanEstadoView, IngresoAsignarTecnicoView, CatalogoTecnicosView,
    ...
    BejermanIngressCompaniesView, BejermanPdfOutputSettingsView, BejermanJobsView, BejermanJobRetryView,
    BejermanRemitoProcessesView, BejermanRemitoProcessRetryView, BejermanArticleMappingsView, BejermanArticlesView,
    ...
    DeliveryOrderInvoicedView, DeliveryOrderNotBillableView, DeliveryOrderCancelView, DeliveryOrderRemitoLocationView,
    ...
    DeliveryOrderRemitoPdfView, DeliveryOrderRemitoPrintView,
    DeliveryOrderInvoicePdfView,
    FacturacionCompanyOptionsView, FacturacionClienteDocumentosView, FacturacionDocumentoPdfView,
    CobranzasRemitosView, CobranzasRemitoPdfView, CobranzasRemitoPrintView,
    ServiceOrderBillingListView, ServiceOrderBillingInvoiceView, ServiceOrderBillingPdfView,
    RouteSheetView, RouteSheetDetailView, RouteSheetCompleteView, RouteSheetPostponeView,
    RouteSheetCancelView, RouteSheetReorderView, RouteSheetLocationsView, RouteSheetSuggestedDeliveryOrdersView,
...
urlpatterns = [
    ...
    path("bejerman/pdf-output-settings/", BejermanPdfOutputSettingsView.as_view()),
    path("bejerman/jobs/", BejermanJobsView.as_view()),
    path("bejerman/jobs/<int:job_id>/retry/", BejermanJobRetryView.as_view()),
    path("bejerman/remitos/", BejermanRemitoProcessesView.as_view()),
    path("bejerman/remitos/<str:source>/<str:process_id>/retry/", BejermanRemitoProcessRetryView.as_view()),
    ...
    path("ordenes-entrega/<str:order_id>/remito/pdf/", DeliveryOrderRemitoPdfView.as_view()),
    path("ordenes-entrega/<str:order_id>/remito/print/", DeliveryOrderRemitoPrintView.as_view()),
    ...
    path("ordenes-entrega/<str:order_id>/no-facturar/", DeliveryOrderNotBillableView.as_view()),
    ...
    path("hoja-ruta/", RouteSheetView.as_view()),
    path("hoja-ruta/reordenar/", RouteSheetReorderView.as_view()),
    path("hoja-ruta/lugares/", RouteSheetLocationsView.as_view()),
    path("hoja-ruta/lugares/<int:location_id>/", RouteSheetLocationDetailView.as_view()),
    path("hoja-ruta/ordenes-sugeridas/", RouteSheetSuggestedDeliveryOrdersView.as_view()),
    path("hoja-ruta/<str:stop_id>/", RouteSheetDetailView.as_view()),
    path("hoja-ruta/<str:stop_id>/completar/", RouteSheetCompleteView.as_view()),
    path("hoja-ruta/<str:stop_id>/posponer/", RouteSheetPostponeView.as_view()),
    path("hoja-ruta/<str:stop_id>/cancelar/", RouteSheetCancelView.as_view()),
    ...
    path("cobranzas/remitos/<str:document_id>/print/", CobranzasRemitoPrintView.as_view()),
    ...
    path("ingresos/<int:ingreso_id>/quitar-reparar/", QuitarRepararView.as_view()),
    ...
    path("ingresos/<int:ingreso_id>/no-se-repara/", MarcarNoSeReparaView.as_view()),
    path("ingresos/<int:ingreso_id>/quitar-estado-final-reparacion/", QuitarEstadoFinalReparacionView.as_view()),
    ...
    path("ingresos/<int:ingreso_id>/bejerman-estado/", IngresoBejermanEstadoView.as_view()),
