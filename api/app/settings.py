...
BEJERMAN_STOCK_ENTRY_COMPROBANTE = os.getenv("BEJERMAN_STOCK_ENTRY_COMPROBANTE", "RIS")
BEJERMAN_STOCK_EXIT_COMPROBANTE = os.getenv("BEJERMAN_STOCK_EXIT_COMPROBANTE", "RSS")
