...
BEJERMAN_BRIDGE_BASE_URL = os.getenv("BEJERMAN_BRIDGE_BASE_URL", "")
BEJERMAN_BRIDGE_SERVICE_TOKEN = os.getenv("BEJERMAN_BRIDGE_SERVICE_TOKEN", "")
BEJERMAN_BRIDGE_TIMEOUT = int(os.getenv("BEJERMAN_BRIDGE_TIMEOUT", os.getenv("BEJERMAN_REQUEST_TIMEOUT", "30")))
